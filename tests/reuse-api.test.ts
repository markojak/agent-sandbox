...
describe("favorites, recents, and duplicate flow APIs", () => {
  ...
  it("favorites CRUD is user-scoped and blocks cross-user access", async () => {
    const entryResponse = assertResponse(
      await postEntries(
    ...
    const favoriteResponse = assertResponse(
      await postFavorites(
    ...
    const userAFavorites = assertResponse(
    ...
    const userBFavorites = assertResponse(
    ...
    const crossUserDelete = assertResponse(
    ...
    const ownerDelete = assertResponse(
  ...
  it("recents returns latest unique meals in descending recency", async () => {
    ...
    const recentsResponse = assertResponse(
  ...
  it("reuse actions emit telemetry events for favorite/recent/duplicate", async () => {
    ...
    const telemetryResponse = assertResponse(
  ...
  it("all APIs require authenticated user header", async () => {
    const response = assertResponse(await getEntries(new Request("http://localhost/api/entries")));
